...
[ExamTools](https://exam.tools) will automatically list your sessions on HamStudy which is where applicants will find and register for your session.
...
[ExamTools](https://exam.tools) in conjunction with HamStudy is the only authorized platform to register applicants.
...
It is worth noting that there is a feature on [ExamTools](https://exam.tools) that allows you to bypass HamStudy and directly add applicants to your session.

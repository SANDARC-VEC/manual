...
> ⚠ **NOTE — FCC Application Fee:** All applicants for a new license must pay a mandatory $35 fee directly to the FCC. Applicants will receive an email from the FCC with payment instructions after SANDARC submits their session data. The payment link is https://apps.fcc.gov/cores/paymentFrnLogin.do and the fee must be paid within 10 calendar days or the FCC will dismiss the application.
